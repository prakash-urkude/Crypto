...
const handleBuy = () => {
    navigate(`/Buy/${params.coinId}`);
};
const handleSell = () => {
    navigate(`/Sell/${params.coinId}`);
};
const handleRedirect = () => {
    window.location.href = 'https://global.bittrex.com/instant?market=BTC-USD&side=BUY';
  };
        ...
        <div>
            ...
            <div className='coin-container'>
                <div className='content'>
                    <h1>{coin.name}</h1>
                    <div className='bs'>
                    <button onClick={handleBuy} className='btnB'>Buy</button>
                    <button onClick={handleSell} className='btnS'>Sell</button>
                    <button onClick={handleRedirect} className='btn'>Invest With Bittrex Global</button>
                    </div>
                </div>
